...
workbook1 = xlsxwriter.Workbook('ORResults.xlsx')
...
for row_index in range(-1, totalrows):
    ...
    for col_index in range(0, totalcoloumns):
       ...
       # writing the data to Resultsfor2 excel file
	            ...
	            if ( col_index == 2 ): 
			                if ( worksheet.cell(row_index, col_index).value == 'Passed' ): passcount += 1
						#elif ( worksheet.cell(row_index, col_index).value == 'Passed' ): 
						     #failcount += 1
						# else : 
						#    parcialcount += 1
